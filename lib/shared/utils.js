...
var Utils = /** @class */ (function () {
    ...
    Utils.getEntryPointAndHandlerPath = function (handler, config) {
        ...
        var runtimeExtensions = config["custom"]["type"] === "module" ?
            "esmodule" : runtime_1.getRuntimeLanguage(config.provider.runtime);
        var extension = constants_1.constants.runtimeExtensions[runtimeExtensions];
        var handlerPath = ((handlerSplit.length > 1) ? handlerSplit[0] : handler) + extension;
        return {
            entryPoint: entryPoint,
